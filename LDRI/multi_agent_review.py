...
def _soc_prompt(packet: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "        db ∈ [0.01, 0.05] — penalty-free zone near target; a wider deadband is PREFERRED to allow\n"
...
def _fuel_prompt(packet: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "  To increase h2 optimization pressure: raise the fixed coefficient directly.\n\n"
        ...
        "soft_revise criteria (only when pass criteria are NOT met):\n"
        "- h2_cost is structurally correct (pure proportional) but effective_w_h2 is too small\n"
...
def _hacking_prompt(packet: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "- Any in-bounds SOC proximity gate that suppresses the h2_cost signal\n"
        "  (e.g., band width > 0.05 on [0.4, 0.8] range used as a gate condition)\n\n"
        "Decision rules:\n"
...
def _battery_usage_prompt(packet: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "    RECOMMEND: reduce w_soc 15-25% OR introduce deadband db≈0.01-0.02\n"
...
_ORCHESTRATOR_PROMPT_TEMPLATE = (
    ...
    "      'reduce w_soc by 10-20% OR introduce deadband db≈0.01 in soc_cost base term'\n"
...
def _build_proposer_prompt(
    ...
    return (
        ...
        "        (a) Pure quadratic:    w_soc * (soc - soc_target)^2\n"
        "        (b) Deadband quadratic: w_soc * k_inbounds * max(0, |soc - soc_target| - db)^2\n"
        "            where db ∈ [0.005, 0.015] — enables battery buffering zone near target\n"
        ...
        "- To emphasize h2 optimization: increase w_h2 coefficient directly\n"
